...
#ifndef TESTJENKINSDEMO_SWIFT_H
#define TESTJENKINSDEMO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TestJenkinsDemo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15TestJenkinsDemo11AppDelegate")
...
@class UIWindow;
@class UIScene;
SWIFT_CLASS("_TtC15TestJenkinsDemo13SceneDelegate")
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC15TestJenkinsDemo14ViewController")
